...
**Documentation boundary:** this checkout contains the specification update.
The linked Claude Doc and active feature branches must receive the same decision
before this is treated as synchronized across sessions; no such synchronization
is implied by editing this file.
