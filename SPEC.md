...
- **Reactions are code and name nobody.** The PoC has four: go and look where the belief points, have it out with the person it is about, throw them out, warn them. Each is a row with two parts: how it is offered (or that it cannot be done now), and how it is carried out through validated effects. A new reaction is a new row.
...
Rebuilt this way, from code paths that named Mara: her search of the cellar, her having it out with whoever is implicated, and her answer to a brawl. Still named in engine code, as debt: Odo's checking and burning, Tobin's conscience and guarded tongue, the search of the pack, the verdict, and who a witness carries a tale to. A test ratchets the count of names per engine file downward (section 17).
...
- [ ] How much of an NPC's reacting is content, and how much is engine? The PoC's engine named characters: Mara's search of the cellar, her having it out with whoever is implicated, her ejecting a brawler, Tobin's guarded tongue and Odo's burning of the ledger were each a code path with a name in it, and each was added after a playtest showed a gap, which is the pattern to stop. **Partly settled, 2026-09-18:** the first three were rebuilt as dispositions in content over one reaction pipeline (section 9), inside the existing `pick_action` and `pick_speech_act` families, and the named versions were deleted. The six routes, re-measured live at ten seeds each, came out as before: evidence 9 of 10 (was 9), exposing the culprit 10 of 10 (was 10), a witness 5 of 10 (was 6, and that route turns on two dice), and 0 of 10 for the bare return, denial and threats. Character names in engine files went from 101 to 76, held by a ratchet test. Still open: Odo's checking and burning, Tobin's conscience and guarded tongue, the search of the pack, the verdict, and who a witness carries a tale to. Whether the rest fits the existing families or needs the backlog family "reactions and appraisal" (section 14) is decided when they are moved. NPCs also do not yet choose by the needs graph (section 4); only the player attempts things.
