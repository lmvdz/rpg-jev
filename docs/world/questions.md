...
| Q060 | Do supported cues help players predict unfamiliar consequences? | Needs measurement | [Presentation evidence](presentation-and-explanation.md#open-decisions-and-implementation-evidence), [accepted learning milestone](experimentation.md#first-milestone-learn-a-rule-and-use-it-creatively) and [proposed journeys](experimentation-journeys.md); prediction and transfer evidence, wolf/non-wolf fixtures, legibility and multiplayer leakage tests; worked designs are not measurements, and protocol/thresholds remain open |
