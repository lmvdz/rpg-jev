/** Pure conversion of the existing clearing's authored rows into initial matter.
 * Shared by the local adapter and authoritative host; no renderer, I/O or outcomes.
 */
